...
class HexMaze {
  constructor(w, h, startX, startY, difficulty, endX, endY) {
    this.w = w;
    this.h = h;
    this.numCells = w * h;
    this.numLeafCells = 0;
    ...
    this.calculateCellDistancesFromStart(startX, startY);

    this.determineMazeEndAndDifficulty(difficulty, endX, endY);
